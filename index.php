...
<html>
  <head>
    <meta charset="utf-8">
    <title>Ludovic CATEL</title>
    <link rel="stylesheet" href="private/vendor/bootstrap/dist/css/bootstrap.min.css" media="screen">
    <link rel="stylesheet" href="private/vendor/font-awesome/css/font-awesome.min.css">
  ...
  <body>
      ...
      <div class="container-fluid">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#">
            <img alt="Brand" src="public/img/cherry.jpg" width="25">
          </a>
        </div>
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav">
            <li class="active"><a href="#1">Présentation<span class="sr-only panel"></span></a></li>
            <li><a href="#2" class="move">Expériences</a></li>
            <li><a href="#3" class="move">Compétences</a></li>
            <li><a href="#4" class="move">PortFolio</a></li>
            <li><a href="#5" class="move">Contact</a></li>
          </ul>
        </div>
      </div>
    </nav>
          ...
          <div class="row">
            <section id="presentation">
              ...
              <div class="center-align">
                <a class="btn" href="public/download/integrateur.pdf" target="_blank"><i class=""></i>Intégrateur Web</a>
                <a class="btn" href="public/download/developpeur.pdf" target="_blank"><i class=""></i>Développeur Web</a>
              </div>
            ...
            <section id="competences">
              ...
              <div class="col-md-8 col-md-offset-2" id="arrow">
                <a href="#portfolio" class="arrow-bottom">
                  <div>
                    <i class="fa fa-chevron-down fa-3x"></i>
                    <i class="fa fa-chevron-down fa-2x"></i>
                  </div>
    ...
    <script src="public/js/jquery.HSlider.min.js"></script>
  </body>
</html>
